...
EVERY LATER TIME
Use the Desktop shortcut. It checks the hosted WLX manifest, verifies the XML with SHA-256,
replaces one canonical XML, quarantines matching numbered/duplicate copies, and opens Cockatrice.
...
%LOCALAPPDATA%\AlexCockatriceAltArt\quarantine
